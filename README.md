...
## Dotfiles that live on Owen Klaiss's machines
...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/oklaiss/dotfiles/master/install.sh \`"
...
If you are on Mac OSX Sierra use [Karabiner Elements](https://github.com/tekezo/Karabiner-Elements) instead.
